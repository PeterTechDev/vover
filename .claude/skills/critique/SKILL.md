...
- **Command**: Which command to use (prefer: /onboard, /extract, /typeset, /clarify, /colorize, /distill, /polish, /adapt, /delight, /bolder, /animate, /normalize, /arrange, /overdrive, /audit, /quieter, /critique, /optimize, /harden — or other installed skills you're sure exist)
